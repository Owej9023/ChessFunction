...
for (value in timepermove){
  ...
  if (count %% 2 == 0){
    ...
    if (length(blacktimepermove != 0)){
      ...
      #blacktimepermove<-c(blacktimepermove,((value))-(blacktimepermove[blackcount]))
      #print(value)
      #print(blacktimepermove)
...
#However, i do not think it is rounding to the nearest tenth
#it is also not using the correct starting values for the black pieces
