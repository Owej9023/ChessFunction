...
#try to see if you can use combined_df$time_control instead of hard coding everything
...
if (tolower(input$ChessGameType) == 'bullet'){
  ...
  #Possible to ignore daily  games for the analysis of time spent per move as the amount of time they acutally have and the time spent on the game are not the same. 
...
#NEED TO CATCH CUSTOM GAMES AND REMOVE THEM FROM ANALYSIS BECAUSE I DONT WANT WANT TO DEAL WITH CREATING A FUNCTION TO CATERGORIZE CUSTOM GAMES.
